                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr v-for="(record,index) in records.data">
                                ...
                                <td><div class="btn-group"><button class="btn btn-warning" v-on:click="openModal(true, record)" v-bind:title="'edit ' + record.card"><i class="fa fa-pencil"></i></button><button class="btn btn-danger" v-on:click="deleteRecord(record)" v-bind:title="'hapus ' + record.card"><i class="fa fa-trash"></i></button></div></td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" class="form-control" name="kartu_id" v-model="recordSlot.card" v-validate="'required|max:191'">
