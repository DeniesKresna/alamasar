            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" class="form-control" name="negara" v-model="recordSlot.nation" v-validate="'required|max:191'">
                            <span class="err" v-if="errors.first('negara')">@{{ errors.first('negara') }}</span>
                        </div>                        
                    </div>               
                </div>  
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" v-on:click="closeModal">Tutup</button>
