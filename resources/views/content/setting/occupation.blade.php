...
@extends('dashboard')
@section('content')
    <occupation-table inline-template>
  <div class="row">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" class="form-control" name="pekerjaan" v-model="recordSlot.occupation" v-validate="'required|max:191'">
                            <span class="err" v-if="errors.first('pekerjaan')">@{{ errors.first('pekerjaan') }}</span>
                        </div>                        
                    </div>               
                </div>  
            </div>
